...
import SectionUpdateAnimation from './section-update-animation';
...
export default function QuestionPreview({ question, updatedSections = [] }: QuestionPreviewProps) {
  return (
    <div className="mx-auto max-w-4xl space-y-10 p-10">
      {/* Question Title */}
      <SectionUpdateAnimation updated={updatedSections.includes('title')}>
      ...
      </SectionUpdateAnimation>

      {/* Question Description */}
      <SectionUpdateAnimation updated={updatedSections.includes('description')}>
        <section>
      ...
      <SectionUpdateAnimation updated={updatedSections.includes('requirements')}>
        <section>
          <div className="mb-4 flex items-center">
      ...
      {/* Sample Interactions */}
      <SectionUpdateAnimation updated={updatedSections.includes('sampleInteractions')}>
        <section>
          <div className="mb-4 flex items-center">
