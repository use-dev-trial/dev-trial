...
export function QuestionSection({ width }: QuestionSectionProps) {
  return (
    <div className="overflow-y-auto border-r border-gray-200" style={{ width: `${width}%` }}>
      <div className="p-4">
        <div className="mb-4 flex items-center gap-2 text-sm text-gray-600">
          <span>QUESTION DESCRIPTION</span>
        </div>

        <h2 className="mb-4 text-2xl font-bold">Code Review Feedback</h2>
        ...
        <h3 className="mb-3 text-xl font-bold">Detailed Requirements</h3>
